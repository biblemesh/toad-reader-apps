    ...
    const dialogBody = (
      <View
        style={{
          ...
          right: 0,
          bottom: 0,
          backgroundColor: invisibleBackdrop
            ? 'transparent'
            : 'rgba(0,0,0,0.5)',
      ...
      >
        <View style={{ width }}>
          ...
          >
                ...
                <View style={styles.messageContainer}>
                  {!(message instanceof Array)
                    ...
                    : message.map((paragraph, idx) => (
                        ...
                        >
                          <Text
                            style={[styles.messageText, paragraph.textStyle]}
                          >
            ...
            {!!submitting && <CoverAndSpin percentage={submittingPercentage} />}
          </View>
        </View>
      </View>
    );
